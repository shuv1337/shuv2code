...
const rule = createOxlintRuleHarness("shuv2code/no-manual-effect-runtime-in-tests", {
  filename: "fixture.test.ts",
});

describe("shuv2code/no-manual-effect-runtime-in-tests", () => {
  rule.valid(
...
const productionRule = createOxlintRuleHarness("shuv2code/no-manual-effect-runtime-in-tests");
