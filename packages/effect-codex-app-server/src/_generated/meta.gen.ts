...
export const UPSTREAM_PROTOCOL_REF = "e363b08c9175ac1cbe5893615dd2cb9ddf95043b" as const;
...
export interface ClientRequestParamsByMethod {
  ...
  readonly "thread/realtime/start": CodexSchema.ThreadRealtimeStartParams;
  readonly "thread/realtime/appendAudio": CodexSchema.ThreadRealtimeAppendAudioParams;
  readonly "thread/realtime/appendText": CodexSchema.ThreadRealtimeAppendTextParams;
  readonly "thread/realtime/appendSpeech": CodexSchema.ThreadRealtimeAppendSpeechParams;
  readonly "thread/realtime/stop": CodexSchema.ThreadRealtimeStopParams;
  readonly "thread/realtime/listVoices": CodexSchema.ThreadRealtimeListVoicesParams;
}
...
export interface ClientRequestResponsesByMethod {
  ...
  readonly "thread/realtime/start": CodexSchema.ThreadRealtimeStartResponse;
  readonly "thread/realtime/appendAudio": CodexSchema.ThreadRealtimeAppendAudioResponse;
  readonly "thread/realtime/appendText": CodexSchema.ThreadRealtimeAppendTextResponse;
  readonly "thread/realtime/appendSpeech": CodexSchema.ThreadRealtimeAppendSpeechResponse;
  readonly "thread/realtime/stop": CodexSchema.ThreadRealtimeStopResponse;
  readonly "thread/realtime/listVoices": CodexSchema.ThreadRealtimeListVoicesResponse;
}
...
export const CLIENT_REQUEST_PARAMS = {
  ...
  "thread/realtime/start": CodexSchema.ThreadRealtimeStartParams,
  "thread/realtime/appendAudio": CodexSchema.ThreadRealtimeAppendAudioParams,
  "thread/realtime/appendText": CodexSchema.ThreadRealtimeAppendTextParams,
  "thread/realtime/appendSpeech": CodexSchema.ThreadRealtimeAppendSpeechParams,
  "thread/realtime/stop": CodexSchema.ThreadRealtimeStopParams,
  "thread/realtime/listVoices": CodexSchema.ThreadRealtimeListVoicesParams,
} as const;
...
export const CLIENT_REQUEST_RESPONSES = {
  ...
  "thread/realtime/start": CodexSchema.ThreadRealtimeStartResponse,
  "thread/realtime/appendAudio": CodexSchema.ThreadRealtimeAppendAudioResponse,
  "thread/realtime/appendText": CodexSchema.ThreadRealtimeAppendTextResponse,
  "thread/realtime/appendSpeech": CodexSchema.ThreadRealtimeAppendSpeechResponse,
  "thread/realtime/stop": CodexSchema.ThreadRealtimeStopResponse,
  "thread/realtime/listVoices": CodexSchema.ThreadRealtimeListVoicesResponse,
} as const;
