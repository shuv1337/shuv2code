...
import { RelayManagedEndpoint } from "@shuv2code/contracts/relay";
...
export class RemoteDpopAccessToken extends Schema.Class<RemoteDpopAccessToken>(
  "@shuv2code/client-runtime/authorization/RemoteDpopAccessToken",
)({
...
>()("@shuv2code/client-runtime/authorization/tokenStore/RemoteDpopAccessTokenStore") {}
