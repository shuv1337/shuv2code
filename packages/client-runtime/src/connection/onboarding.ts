import type { DesktopSshEnvironmentTarget, EnvironmentId } from "@shuv2code/contracts";
import { resolveRemotePairingTarget } from "@shuv2code/shared/remote";
...
>()("@shuv2code/client-runtime/connection/onboarding/ConnectionOnboarding") {}
