import { ORCHESTRATION_WS_METHODS, WS_METHODS } from "@shuv2code/contracts";
...
}>("@shuv2code/client-runtime/rpc/EnvironmentRpcRequestObserver", {
  defaultValue: () => ({
...
export type EnvironmentSubscriptionRpcTag =
  ...
  | typeof WS_METHODS.subscribeVoiceEvents
  | typeof WS_METHODS.previewAutomationConnect
  | typeof WS_METHODS.subscribeVcsStatus
  | typeof WS_METHODS.subscribeAdeFleetHealth
  | typeof WS_METHODS.subscribeAdeRoster
...
}>("@shuv2code/client-runtime/rpc/EnvironmentRpcSubscriptionObserver", {
  defaultValue: () => ({
    observe: () => Effect.succeed(Effect.void),
  }),
}) {}
