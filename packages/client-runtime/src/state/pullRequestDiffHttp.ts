import type { PullRequestDiffInput, PullRequestDiffResult } from "@shuv2code/contracts";
...
>()("@shuv2code/client-runtime/state/pullRequestDiffHttp/PullRequestDiffLoader") {}
