...
import { applyGitStatusStreamEvent } from "@shuv2code/shared/git";
...
export function createVcsEnvironmentAtoms<R, E>(
  ...
  return {
    ...
    describeChange: createEnvironmentRpcCommand(runtime, {
      label: "environment-data:vcs:describe-change",
      tag: WS_METHODS.vcsDescribeChange,
      scheduler: vcsCommandScheduler,
      concurrency: vcsCommandConcurrency,
      onSettled: invalidateRefs,
    }),
    startChange: createEnvironmentRpcCommand(runtime, {
      label: "environment-data:vcs:start-change",
      tag: WS_METHODS.vcsStartChange,
      scheduler: vcsCommandScheduler,
      concurrency: vcsCommandConcurrency,
      onSettled: invalidateRefs,
    }),
    pushBookmark: createEnvironmentRpcCommand(runtime, {
      label: "environment-data:vcs:push-bookmark",
      tag: WS_METHODS.vcsPushBookmark,
      scheduler: vcsCommandScheduler,
      concurrency: vcsCommandConcurrency,
      onSettled: invalidateRefs,
    }),
    createChangeRequest: createEnvironmentRpcCommand(runtime, {
      label: "environment-data:vcs:create-change-request",
      tag: WS_METHODS.vcsCreateChangeRequest,
      scheduler: vcsCommandScheduler,
      concurrency: vcsCommandConcurrency,
      onSettled: invalidateRefs,
    }),
