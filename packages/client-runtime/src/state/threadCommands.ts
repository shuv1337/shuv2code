...
import {
  ...
  type PrepareThreadHistoryInput,
...
export function createThreadEnvironmentAtoms<R, E>(
  ...
  return {
    ...
    prepareHistory: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:prepare-history",
      execute: (input: PrepareThreadHistoryInput) => prepareThreadHistory(input),
      scheduler,
      concurrency,
    }),
  };
