...
import { Shuv2CodeProjectFile } from "./shuv2codeProjectFile.ts";

const decode = Schema.decodeUnknownSync(Shuv2CodeProjectFile);

describe("Shuv2CodeProjectFile", () => {
  it("decodes a full project file", () => {
    const decoded = decode({
      $schema: "./schemas/shuv2code.schema.json",
