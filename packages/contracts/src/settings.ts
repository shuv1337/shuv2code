...
import { VcsSelectableKind } from "./vcs.ts";
...
export const ClientSettingsSchema = Schema.Struct({
  ...
  showIgnoredFiles: Schema.Boolean.pipe(Schema.withDecodingDefault(Effect.succeed(true))),
...
export const CodexSettings = makeProviderSettingsSchema(
  {
    ...
    shadowHomePath: TrimmedString.pipe(
      ...
      Schema.annotateKey({
        ...
        providerSettingsForm: {
          placeholder: "~/.codex-shuv2code/personal",
          clearWhenEmpty: "omit",
        },
      }),
    ),
...
export const OpenCodeSettings = makeProviderSettingsSchema(
  {
    ...
    serverUrl: TrimmedString.pipe(
      ...
      Schema.annotateKey({
        title: "Server URL",
        description: "Leave blank to let shuv2code spawn the server when needed.",
        providerSettingsForm: {
...
export const OpenCodeV2Settings = makeProviderSettingsSchema(
  {
    enabled: Schema.Boolean.pipe(
      Schema.withDecodingDefault(Effect.succeed(true)),
      Schema.annotateKey({ providerSettingsForm: { hidden: true } }),
    ...
    binaryPath: makeBinaryPathSetting("opencode").pipe(
      Schema.annotateKey({
        title: "Binary path",
        description: "Path to the OpenCode v2 binary.",
        providerSettingsForm: {
          placeholder: "opencode",
          clearWhenEmpty: "omit",
        },
    ...
    serverUrl: TrimmedString.pipe(
      ...
      Schema.annotateKey({
        title: "Server URL",
        description: "Leave blank to attach to the running OpenCode v2 background service.",
        providerSettingsForm: {
          placeholder: "http://127.0.0.1:4096",
          clearWhenEmpty: "omit",
        },
...
export type OpenCodeV2Settings = typeof OpenCodeV2Settings.Type;
...
export const ServerSettings = Schema.Struct({
  ...
  defaultVcsKind: VcsSelectableKind.pipe(
  ...
  providers: Schema.Struct({
    ...
    opencodeV2: Schema.optionalKey(OpenCodeV2Settings),
  }).pipe(Schema.withDecodingDefault(Effect.succeed({}))),
...
const OpenCodeV2SettingsPatch = Schema.Struct({
  enabled: Schema.optionalKey(Schema.Boolean),
  binaryPath: Schema.optionalKey(TrimmedString),
  serverUrl: Schema.optionalKey(TrimmedString),
  serverPassword: Schema.optionalKey(TrimmedString),
...
export const ServerSettingsPatch = Schema.Struct({
  ...
  defaultVcsKind: Schema.optionalKey(VcsSelectableKind),
  ...
  providers: Schema.optionalKey(
    Schema.Struct({
      ...
      opencodeV2: Schema.optionalKey(OpenCodeV2SettingsPatch),
    }),
  ),
