...
>()("@shuv2code/contracts/environmentHttp/EnvironmentAuthenticatedPrincipal") {}
...
export class EnvironmentMetadataHttpApi extends HttpApiGroup.make("metadata").add(
  HttpApiEndpoint.get("descriptor", "/.well-known/shuv2code/environment", {
...
const EnvironmentOrchestrationThreadHistoryInput = Schema.Struct({
  threadId: ThreadId,
...
export class EnvironmentOrchestrationHttpApi extends HttpApiGroup.make("orchestration")
  ...
  .add(
    HttpApiEndpoint.post("threadHistory", "/api/orchestration/thread-history", {
      headers: OptionalBearerHeaders,
      payload: EnvironmentOrchestrationThreadHistoryInput,
...
export class EnvironmentConnectHttpApi extends HttpApiGroup.make("connect")
  ...
  .add(
    HttpApiEndpoint.post("health", "/api/shuv2code-connect/health", {
  ...
  .add(
    HttpApiEndpoint.post("shuv2codeMintCredential", "/api/shuv2code-connect/mint-credential", {
      payload: RelayCloudMintCredentialRequest,
      success: RelayEnvironmentMintResponse,
      error: EnvironmentHttpCloudErrors,
    }),
