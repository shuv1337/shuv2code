...
> = {
  ...
  bitbucket: {
    missing:
      "Bitbucket needs API credentials on the server. Set SHUV2CODE_BITBUCKET_EMAIL and SHUV2CODE_BITBUCKET_API_TOKEN, or SHUV2CODE_BITBUCKET_ACCESS_TOKEN.",
    unauthenticated:
      "Bitbucket rejected the configured credentials. Check SHUV2CODE_BITBUCKET_EMAIL and SHUV2CODE_BITBUCKET_API_TOKEN.",
  },
};
