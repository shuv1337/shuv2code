import type { ThreadEnvMode } from "@shuv2code/contracts";

/**
 * Canonical priority order for a project's default thread env mode:
 * per-project setting > checked-in shuv2code.json > global server setting.
 *
 ...
 * source that outranks shuv2code.json decided, or the file read settled. While
