...
export const RELAY_LINK_PROOF_TYP = "shuv2code-env-link+jwt";
export const RELAY_MINT_REQUEST_TYP = "shuv2code-cloud-mint+jwt";
export const RELAY_HEALTH_REQUEST_TYP = "shuv2code-cloud-health+jwt";
export const RELAY_MINT_RESPONSE_TYP = "shuv2code-env-mint+jwt";
export const RELAY_HEALTH_RESPONSE_TYP = "shuv2code-env-health+jwt";
export const RELAY_ACTIVITY_PUBLISH_TYP = "shuv2code-env-activity+jwt";
