...
export function compactAccessibilityTree(tree: unknown): CompactAccessibilityTree {
  ...
  if (Option.isSome(alreadyCompact)) {
    ...
    return {
      mode: "compact",
      totalNodeCount: compact.totalNodeCount,
      relevantNodeCount: compact.relevantNodeCount,
      includedNodeCount: compact.includedNodeCount,
      ...
      ...(compact.unavailableReason === undefined
        ? {}
        : { unavailableReason: compact.unavailableReason }),
    };
  }
