...
function getGnomeKeyringRemediationMessage(): string {
  return "shuv2code could not access GNOME Keyring to save this environment credential. Install and start GNOME Keyring, then restart shuv2code.";
}

function getKWalletRemediationMessage(): string {
  return "shuv2code could not access KWallet to save this environment credential. Enable the KDE wallet subsystem in System Settings, then restart shuv2code.";
}
