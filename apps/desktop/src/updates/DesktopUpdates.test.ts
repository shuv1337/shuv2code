...
import type { DesktopUpdateState } from "@shuv2code/contracts";
...
function makeHarness(options: UpdatesHarnessOptions = {}) {
  ...
  const environmentLayer = DesktopEnvironment.layer({
    ...
    homeDirectory: `/tmp/shuv2code-desktop-updates-home-${process.pid}`,
    platform: "darwin",
    processArch: "x64",
    appVersion: "1.2.3",
    appPath: "/repo",
    ...
    Layer.provide(
      Layer.mergeAll(
        ...
        DesktopConfig.layerTest({
          SHUV2CODE_HOME: `/tmp/shuv2code-desktop-updates-test-${process.pid}`,
          SHUV2CODE_DESKTOP_MOCK_UPDATES: "true",
          SHUV2CODE_DESKTOP_MOCK_UPDATE_SERVER_PORT: "4141",
          ...options.env,
        }),
      ),
    ),
