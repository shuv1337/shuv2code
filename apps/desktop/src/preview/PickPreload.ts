...
const OVERLAY_ATTRIBUTE = "data-shuv2code-annotation-ui";
const Z_INDEX_OVERLAY = 2147483646;
const PRIMARY = "var(--shuv2code-primary)";
const PRIMARY_FILL = "color-mix(in srgb, var(--shuv2code-primary) 10%, transparent)";
...
const applyAnnotationTheme = (
  ...
  const variables = {
    "--shuv2code-radius": theme.radius,
    "--shuv2code-background": theme.background,
    "--shuv2code-foreground": theme.foreground,
    "--shuv2code-popover": theme.popover,
    "--shuv2code-popover-foreground": theme.popoverForeground,
    "--shuv2code-primary": theme.primary,
    "--shuv2code-primary-foreground": theme.primaryForeground,
    "--shuv2code-muted": theme.muted,
    "--shuv2code-muted-foreground": theme.mutedForeground,
    "--shuv2code-accent": theme.accent,
    "--shuv2code-accent-foreground": theme.accentForeground,
    "--shuv2code-border": theme.border,
    "--shuv2code-input": theme.input,
    "--shuv2code-ring": theme.ring,
    "--shuv2code-font-sans": theme.fontSans,
    "--shuv2code-font-mono": theme.fontMono,
  };
...
function startAnnotation(): void {
  ...
  const refreshToolButtons = (): void => {
    ...
    document.documentElement.setAttribute("data-shuv2code-annotation-tool", tool);
  };
      ...
      if (isUsableRect(rect)) {
        ...
        if (found === 0) {
          ...
          const regionBox = createBox(
            PRIMARY,
            "color-mix(in srgb, var(--shuv2code-primary) 6%, transparent)",
          );
  ...
  const teardown = (notifyMain: boolean): void => {
    ...
    document.documentElement.removeAttribute("data-shuv2code-annotation-tool");
    cursorStyle.remove();
    host.remove();
    activeSession = null;
