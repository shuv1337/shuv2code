...
export const PREVIEW_ENSURE_BACKGROUND_TAB_CHANNEL = "desktop:preview-ensure-background-tab";
export const PREVIEW_ADOPT_BACKGROUND_TAB_CHANNEL = "desktop:preview-adopt-background-tab";
export const PREVIEW_GET_TAB_HOSTING_CHANNEL = "desktop:preview-get-tab-hosting";
export const PREVIEW_RESIZE_BACKGROUND_TAB_CHANNEL = "desktop:preview-resize-background-tab";
