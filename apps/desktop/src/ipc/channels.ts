...
export const PREVIEW_RECORDING_BEGIN_CHANNEL = "desktop:preview-recording-begin";
export const PREVIEW_RECORDING_APPEND_CHANNEL = "desktop:preview-recording-append";
export const PREVIEW_RECORDING_FINISH_CHANNEL = "desktop:preview-recording-finish";
export const PREVIEW_RECORDING_ABORT_CHANNEL = "desktop:preview-recording-abort";
