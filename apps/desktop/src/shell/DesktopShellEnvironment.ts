...
>()("@shuv2code/desktop/shell/DesktopShellEnvironment") {}
...
const startMarker = (name: string) => `__SHUV2CODE_ENV_${name}_START__`;
const endMarker = (name: string) => `__SHUV2CODE_ENV_${name}_END__`;
