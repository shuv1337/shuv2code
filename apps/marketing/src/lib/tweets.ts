...
export const tweets = [
  ...
  },
  {
    handle: "aronprins",
    content:
      "I already loved T3 Code by @theo and @jullerino, but their Connections implementation is next level epic and for this they should both earn maximum respect.",
  ...
  {
    handle: "uwunetes",
    content: "claude code make me go whine whine whine and t3 code make me go woof woof awooooo!!!",
