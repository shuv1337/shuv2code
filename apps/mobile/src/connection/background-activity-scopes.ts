import type { EnvironmentRpcSubscriptionObservation } from "@shuv2code/client-runtime/rpc";
import { type BackgroundScope, type EnvironmentId, WS_METHODS } from "@shuv2code/contracts";
