...
function RootStackLayout(props: {
  ...
  // Presents the shuv2code connect onboarding sheet after an in-session sign-in.
...
function NotFoundScreen() {
  ...
  return (
    ...
    >
      <Text className="text-3xl font-shuv2code-bold text-foreground" selectable>
        Route not found
      </Text>
      <Pressable
      ...
      >
        <Text className="text-base font-shuv2code-bold text-primary-foreground">Return home</Text>
      </Pressable>
    </ScrollView>
  );
}
