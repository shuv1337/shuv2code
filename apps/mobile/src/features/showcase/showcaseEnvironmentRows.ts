...
const SHOWCASE_LOCAL_ENVIRONMENT_DISPLAY_URLS: Readonly<Record<string, string>> = {
  ...
  "Suspense Station": "https://suspense-vps.hel1.shuv2code.sh/",
...
const pocketPiEndpoint = {
  httpBaseUrl: "https://pocket-pi.shuv2code.sh",
  wsBaseUrl: "wss://pocket-pi.shuv2code.sh",
  providerKind: "shuv2code_relay" as const,
};
...
export const SHOWCASE_CONNECTED_CLOUD_ENVIRONMENTS: ReadonlyArray<ConnectedEnvironmentSummary> = [
  {
    ...
    displayUrl: "https://aurora-gpu.shuv2code.sh",
    isRelayManaged: true,
