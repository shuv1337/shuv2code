import { type KnownTerminalSession } from "@shuv2code/client-runtime/state/terminal";
import { DEFAULT_TERMINAL_ID, type ProjectScript } from "@shuv2code/contracts";
...
} from "@shuv2code/shared/terminalLabels";
