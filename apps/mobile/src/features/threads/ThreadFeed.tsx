...
} from "@shuv2code/shared/chatList";
import { formatElapsed } from "@shuv2code/shared/orchestrationTiming";
...
import { markdownFileIconSource } from "@shuv2code/mobile-markdown-text/file-icons";
import { resolveMarkdownLinkPresentation } from "@shuv2code/mobile-markdown-text/links";
import {
...
function renderFeedEntry(
  ...
  if (entry.type === "turn-fold") {
    return (
      ...
      >
        <Text className="font-shuv2code-medium text-sm tabular-nums text-foreground-muted">
          {entry.label}
        </Text>
        <SymbolView
      ...
      return (
        ...
        >
          ...
          <View className="mt-1 flex-row items-center justify-end gap-1 pr-0.5">
            <Text className="font-shuv2code-medium text-xs tabular-nums text-neutral-600 dark:text-neutral-400">
              {timestampLabel}
            </Text>
            {message.text.trim().length > 0 ? (
              <CopyTextButton
