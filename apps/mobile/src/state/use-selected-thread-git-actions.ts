...
import { EnvironmentProject, EnvironmentThreadShell } from "@shuv2code/client-runtime/state/shell";
...
import type { GitRunStackedActionResult } from "@shuv2code/contracts";
import {
