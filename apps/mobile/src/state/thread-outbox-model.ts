import { isTransportConnectionErrorMessage } from "@shuv2code/client-runtime/errors";
import type { EnvironmentShellStatus } from "@shuv2code/client-runtime/state/shell";
import {
  CommandId,
  EnvironmentId,
  IsoDateTime,
