...
const CONNECTIONS_KEY = "shuv2code.connections";
const AGENT_AWARENESS_DEVICE_ID_KEY = "shuv2code.agent-awareness.device-id";
const AGENT_AWARENESS_REGISTRATION_KEY = "shuv2code.agent-awareness.registration";
const RECENT_THREAD_SHORTCUTS_KEY = "shuv2code.recent-thread-shortcuts";
...
>()("@shuv2code/mobile/persistence/MobileStorage") {}
