...
private final class ComposerTextView: UITextView {
  private static let pastedImageDirectoryName = "shuv2code-composer-paste"
...
public final class Shuv2CodeComposerEditorView: ExpoView, UITextViewDelegate, UITextDropDelegate {
