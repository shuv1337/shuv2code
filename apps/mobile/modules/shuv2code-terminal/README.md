# shuv2code Mobile Terminal Native Module
...
fork, with shuv2code's iOS 16 compatibility patch applied. `Shuv2CodeTerminalView` owns a `libghostty` surface and
...
```bash
apps/mobile/modules/shuv2code-terminal/scripts/build-libghostty-ios16.sh
```
...
```bash
apps/mobile/modules/shuv2code-terminal/scripts/build-libghostty-android.sh
```
