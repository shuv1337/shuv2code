...
const customSprite = webIconSource.match(/const SHUV2CODE_FILE_ICON_SPRITE = `([\s\S]*?)`;/)?.[1];

if (!customSprite) {
  throw new Error(
    "Could not read the shuv2code Pierre icon sprite from apps/web/src/pierre-icons.ts",
  );
}
...
const customIcons = {
  agents: "shuv2code-file-icon-agents",
  claude: "shuv2code-file-icon-claude",
  package: "shuv2code-file-icon-package-json",
  pnpm: "shuv2code-file-icon-pnpm",
  readme: "shuv2code-file-icon-readme",
  tsconfig: "shuv2code-file-icon-tsconfig",
};
