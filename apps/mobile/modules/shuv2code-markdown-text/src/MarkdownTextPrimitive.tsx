...
import Shuv2CodeMarkdownTextRunNativeComponent from "./Shuv2CodeMarkdownTextRunNativeComponent";
import Shuv2CodeMarkdownTextNativeComponent from "./Shuv2CodeMarkdownTextNativeComponent";
...
function MarkdownTextPrimitiveChild({ style, children, ...rest }: MarkdownTextPrimitiveProps) {
  ...
  const nativeChildren = React.Children.toArray(children).map((child) => {
    ...
    return (
      ...
      <Shuv2CodeMarkdownTextRunNativeComponent
  ...
  if (!isAncestor) {
    return (
      <TextAncestorContext.Provider value={contextValue}>
        <Shuv2CodeMarkdownTextNativeComponent
          {...textDefaults}
          {...rest}
