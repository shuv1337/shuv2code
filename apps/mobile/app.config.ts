    ...
    widgets: [
      {
        ...
        description: "Shows the current state of active shuv2code agents.",
...
const config: ExpoConfig = {
  ...
  ios: {
    ...
    requireFullScreen: process.env.SHUV2CODE_SHOWCASE_CAPTURE_BUILD === "1",
    ...
    infoPlist: {
      ...
      ...(process.env.SHUV2CODE_SHOWCASE_CAPTURE_BUILD === "1"
        ? {
