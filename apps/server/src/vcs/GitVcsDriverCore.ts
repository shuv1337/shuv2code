...
import { dedupeRemoteBranchesWithLocalMatches, normalizeGitRemoteUrl } from "@shuv2code/shared/git";
import { compactTraceAttributes } from "@shuv2code/shared/observability";
import { decodeJsonResult } from "@shuv2code/shared/schemaJson";
...
> {
  ...
  const traceFilePath = yield* fs.makeTempFileScoped({
    prefix: `shuv2code-git-trace2-${process.pid}-`,
    suffix: ".json",
  });
    ...
    Effect.fn("refreshCheckedOutBranch")(function* (input) {
      ...
      if (!isAncestor) {
        ...
        yield* executeGit(
          ...
          input.cwd,
          ["update-ref", "refs/shuv2code/pre-refresh", headCommit],
