  ...
  const checkpoints: VcsDriver.VcsCheckpointOps = {
    captureCheckpoint: Effect.fn("GitVcsDriver.checkpoints.captureCheckpoint")(function* (input) {
      ...
      const tempIndexPath = path.join(
        gitCommonDir,
        `shuv2code-checkpoint-index-${NodeCrypto.randomUUID()}`,
      );
      const commitEnv: NodeJS.ProcessEnv = {
        ...process.env,
        GIT_INDEX_FILE: tempIndexPath,
        GIT_AUTHOR_NAME: "shuv2code",
        GIT_AUTHOR_EMAIL: "shuv2code@users.noreply.github.com",
        GIT_COMMITTER_NAME: "shuv2code",
        GIT_COMMITTER_EMAIL: "shuv2code@users.noreply.github.com",
      };
      ...
      yield* Effect.gen(function* () {
        ...
        const message = `shuv2code checkpoint ref=${input.checkpointRef}`;
