import { ProjectId } from "@shuv2code/contracts";
import { projectScriptRuntimeEnv, setupProjectScript } from "@shuv2code/shared/projectScripts";
...
>()("@shuv2code/project/ProjectSetupScriptRunner") {}
