...
import { isDevProxiedPath } from "@shuv2code/shared/devProxy";
import { decodeOtlpTraceRecords } from "@shuv2code/shared/observability";
...
const DESKTOP_RENDERER_ORIGINS = ["shuv2code://app", "shuv2code-dev://app"];
...
export const browserApiCorsLayer = Layer.unwrap(
  Effect.gen(function* () {
    ...
    //
    // SHUV2CODE_DEV_ALLOWED_ORIGINS covers dev servers reached from a second
