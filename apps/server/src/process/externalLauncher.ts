...
// per-command cache lookups in @shuv2code/shared/shell.
//
...
// command-resolution cache in @shuv2code/shared/shell, so a backward wall-clock
...
>()("shuv2code/process/externalLauncher") {}
