...
import { PREFERRED_DEFAULT_CODEX_MODELS, ServerSettingsError } from "@shuv2code/contracts";
...
export function buildCodexInitializeParams(): CodexSchema.V1InitializeParams {
  return {
    clientInfo: {
      name: "shuv2code_desktop",
      title: "shuv2code Desktop",
    ...
    if (!codexSettings.enabled) {
      return buildServerProvider({
        ...
        probe: {
          ...
          status: "warning",
          auth: { status: "unknown" },
          message: "Codex is disabled in shuv2code settings.",
        },
      });
    }
