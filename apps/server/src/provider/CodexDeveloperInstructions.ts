import type { ProviderInteractionMode } from "@shuv2code/contracts";

const SHUV2CODE_CODE_BROWSER_TOOL_INSTRUCTIONS = `

## shuv2code collaborative browser
...
${SHUV2CODE_CODE_BROWSER_TOOL_INSTRUCTIONS}
</collaboration_mode>`;
...
<runtime_info>In case you're asked: you are running in shuv2code through the Codex harness, as ${toSingleLine(runtime.model)} with ${toSingleLine(runtime.reasoningEffort)} reasoning effort. No need to mention this otherwise.</runtime_info>`;
}
