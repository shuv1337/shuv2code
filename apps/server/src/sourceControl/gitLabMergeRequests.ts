...
import { PositiveInt, TrimmedNonEmptyString } from "@shuv2code/contracts";
import { decodeJsonResult, formatSchemaError } from "@shuv2code/shared/schemaJson";
...
const GitLabMergeRequestSchema = Schema.Struct({
  ...
  target_project_id: Schema.optional(Schema.NullOr(PositiveInt)),
