...
export const PreviewSnapshotTool = readonlyBrowserTool(
  Tool.make("preview_snapshot", {
    description:
      "Inspect a page before interacting. Pass tabId to inspect a specific tab; omit it to use this agent session's current tab. Returns bounded page state, semantic elements, recent diagnostics, and action history. Set includeScreenshot=true only when visual inspection is needed.",
