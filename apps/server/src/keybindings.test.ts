import { KeybindingCommand, KeybindingRule, KeybindingsConfig } from "@shuv2code/contracts";
...
import { KeybindingsConfigError } from "@shuv2code/contracts";
    ...
    Layer.provideMerge(
      Layer.fresh(
        ServerConfig.layerTest(process.cwd(), {
          prefix: "shuv2code-keybindings-test-",
        }),
      ),
    ),
  );
