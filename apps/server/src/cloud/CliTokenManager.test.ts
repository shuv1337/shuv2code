import { readConnectAuthorizeRequest } from "@shuv2code/shared/connectAuth";
...
const TEST_ENV = {
  SHUV2CODE_CLERK_PUBLISHABLE_KEY: "pk_test_Y2xlcmsuZXhhbXBsZS50ZXN0JA==",
  SHUV2CODE_CLERK_CLI_OAUTH_CLIENT_ID: "oauth_client_test",
  SHUV2CODE_HOSTED_APP_URL: "https://hosted.example.test",
};
