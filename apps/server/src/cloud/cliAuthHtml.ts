...
declare const __SHUV2CODE_BUILD_CHANNEL__: "nightly" | "latest" | undefined;

export function resolveLoopbackAuthorizationStage(): LoopbackAuthorizationStage {
  return typeof __SHUV2CODE_BUILD_CHANNEL__ === "undefined" ? "dev" : __SHUV2CODE_BUILD_CHANNEL__;
}

const stageBrands = {
  dev: "shuv2code (Dev)",
  nightly: "shuv2code (Nightly)",
  latest: "shuv2code",
...
<html lang="en">
  <head>
    ...
    <title>shuv2code connect authorization complete</title>
    <style>
      :root {
  ...
  <body>
    <main>
      ...
      <section class="content">
        ...
        <p class="description">Return to your terminal to finish setting up shuv2code connect. You can close this window.</p>
      </section>
    </main>
  </body>
</html>`;
