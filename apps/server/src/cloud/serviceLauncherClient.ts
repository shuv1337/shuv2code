import type { ServerSelfUpdateOutcome } from "@shuv2code/contracts";
import { HostProcessEnvironment } from "@shuv2code/shared/hostProcess";
  ...
  override get message(): string {
    switch (this.operation) {
      ...
      case "version-mismatch":
        return "The service launcher started a different shuv2code version.";
...
export const ServiceLauncherHostProcess = Context.Reference<ServiceLauncherProcess>(
  "@shuv2code/cloud/serviceLauncherHostProcess",
  {
    defaultValue: () => ({
...
>()("@shuv2code/cloud/serviceLauncherClient") {}
