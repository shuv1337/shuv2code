 ...
 */
import { IsoDateTime, NonNegativeInt } from "@shuv2code/contracts";
...
export interface ProjectionStateRepositoryShape {
  ...
  /** Advance several independent projector cursors in one SQL statement. */
  readonly upsertMany: (
...
>()("shuv2code/persistence/Services/ProjectionState/ProjectionStateRepository") {}
