...
export const RPC_REQUIRED_SCOPES = {
  ...
  [WS_METHODS.voiceGetActiveCall]: AuthOrchestrationReadScope,
  ...
  [WS_METHODS.automationsGet]: AuthOrchestrationReadScope,
  ...
  [WS_METHODS.automationsValidateSchedule]: AuthOrchestrationReadScope,
  ...
  [WS_METHODS.vcsDescribeChange]: AuthOrchestrationOperateScope,
  [WS_METHODS.vcsStartChange]: AuthOrchestrationOperateScope,
  [WS_METHODS.vcsPushBookmark]: AuthOrchestrationOperateScope,
  [WS_METHODS.vcsCreateChangeRequest]: AuthOrchestrationOperateScope,
  ...
  [WS_METHODS.vcsSetProjectPreference]: AuthOrchestrationOperateScope,
