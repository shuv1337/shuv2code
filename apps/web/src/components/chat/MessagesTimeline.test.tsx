import { CheckpointRef, EnvironmentId, MessageId, TurnId } from "@shuv2code/contracts";
        ...
        timelineEntries={[
          {
            ...
            entry: {
              ...
              label: "Updated files",
              tone: "tool",
              changedFiles: ["C:/Users/mike/dev-stuff/shuv2code/apps/web/src/session-logic.ts"],
            },
          },
        ]}
        workspaceRoot="C:/Users/mike/dev-stuff/shuv2code"
      />,
    );

    expect(markup).toContain("shuv2code/apps/web/src/session-logic.ts");
    expect(markup).not.toContain("C:/Users/mike/dev-stuff/shuv2code/apps/web/src/session-logic.ts");
  });
