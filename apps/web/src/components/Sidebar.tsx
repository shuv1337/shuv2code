...
import type { ScopedThreadRef, ThreadId, VcsDriverKind } from "@shuv2code/contracts";
...
const SETTLED_SHELF_EXPANDED_KEY = "shuv2code:sidebar-v2:settled-expanded";
const SNOOZED_SHELF_EXPANDED_KEY = "shuv2code:sidebar-v2:snoozed-expanded";
    ...
    >
      <div className="flex min-w-0 max-w-80 flex-col gap-2 p-[var(--floating-content-inset)]">
        ...
        <div className="grid gap-1.5 pl-0.5 text-xs text-muted-foreground">
          ...
          {shouldShowSidebarThreadError(thread) ? (
...
const SidebarThreadRow = memo(function SidebarThreadRow(props: {
  ...
  // browser. A plain click still opens shuv2code's pull request view.
  const prBadge =
    prStatus && pr ? (
      <a
        href={pr.url}
