...
import { nextTerminalId, resolveTerminalSessionLabel } from "@shuv2code/shared/terminalLabels";
...
import { buildTemporaryWorktreeBranchName } from "@shuv2code/shared/git";
...
function ChatViewContent(props: ChatViewProps) {
  ...
  // the sent message can stay near the top. shuv2code only owns streaming adjustments
  ...
  const rightPanelContent = activeThreadRef ? (
    activeRightPanelSurface?.kind === "preview" ? (
      ...
      <PullRequestsUnavailableState
        ...
        error="Update this environment's shuv2code server to browse pull requests."
      />
