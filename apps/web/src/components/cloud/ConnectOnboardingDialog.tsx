...
import { AuthAdministrativeScopes, AuthRelayWriteScope } from "@shuv2code/contracts";
...
/**
 * Post-sign-in onboarding wizard for shuv2code connect. Opens on every in-session
 ...
 * account's shuv2code connect environments so every device can be connected right
...
function ConfiguredConnectOnboardingDialog() {
  ...
  const applyPublishSelection = async () => {
    ...
    toastManager.add({
      type: "success",
      title: "shuv2code connect enabled",
  ...
  return (
    ...
    >
      <DialogPopup className="max-w-xl">
        <DialogHeader>
          <DialogTitle>Set up shuv2code connect</DialogTitle>
          <DialogDescription>
    ...
    <div className="space-y-3">
      <div className="rounded-lg border">
        <OnboardingToggleRow
          ...
          description="Make this environment available to your other devices through shuv2code connect."
