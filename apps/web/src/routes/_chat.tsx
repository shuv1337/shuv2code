...
import { VoiceSurfaceHostProvider } from "../components/voice/VoiceSurfaceHost";
        ...
        if (!isPreviewSupportedInRuntime()) {
          toastManager.add(
            stackedThreadToast({
              ...
              description: "Open shuv2code in the desktop app to use the in-app preview.",
            }),
          );
          return;
        }
