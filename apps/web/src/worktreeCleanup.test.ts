...
describe("formatWorktreePathForDisplay", () => {
  it("shows only the last path segment for unix-like paths", () => {
    const result = formatWorktreePathForDisplay(
      "/Users/julius/.shuv2code/worktrees/shuv2code-mvp/shuv2code-4e609bb8",
    );
    expect(result).toBe("shuv2code-4e609bb8");
  });

  it("normalizes windows separators before selecting the final segment", () => {
    const result = formatWorktreePathForDisplay(
      "C:\\Users\\julius\\.shuv2code\\worktrees\\shuv2code-mvp\\shuv2code-4e609bb8",
    );
    expect(result).toBe("shuv2code-4e609bb8");
  });

  it("uses the final segment even when outside ~/.shuv2code/worktrees", () => {
