...
import { DEFAULT_RUNTIME_MODE, type ScopedProjectRef, type ThreadId } from "@shuv2code/contracts";
...
import { resolveDefaultThreadEnvMode } from "@shuv2code/shared/threadEnvMode";
import { readThreadShell, useProjects, useThread } from "../state/entities";
import { resolveNewDraftStartFromOrigin } from "../lib/chatThreadActions";
import { readShuv2CodeProjectFileDefaultThreadEnvMode } from "../lib/shuv2codeProjectFileDefaults";
...
export function useNewThreadHandler() {
  ...
  return useCallback(
    (
      ...
      // The shared resolver owns the priority order. The shuv2code.json read is
      ...
      const resolveDefaultEnvMode = async (): Promise<DraftThreadEnvMode> => {
        ...
        return resolveDefaultThreadEnvMode({
          ...
          projectFile: consultProjectFile
            ? await readShuv2CodeProjectFileDefaultThreadEnvMode(
