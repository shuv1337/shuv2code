...
import type { EnvironmentCloudLinkStateResult } from "@shuv2code/contracts";
...
export function usePrimaryCloudLinkState() {
  ...
  if (result._tag === "Failure") {
    ...
    error = cause instanceof Error ? cause.message : "Could not read shuv2code connect link state.";
  }
