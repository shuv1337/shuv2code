...
import { RelayWebClientId } from "@shuv2code/contracts/relay";
...
import { type RpcSession } from "@shuv2code/client-runtime/rpc";
...
beforeEach(() => {
  vi.clearAllMocks();
  vi.stubEnv("VITE_SHUV2CODE_RELAY_URL", "https://relay.example.test");
