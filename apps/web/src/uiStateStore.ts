...
export const PERSISTED_STATE_KEY = "shuv2code:ui-state:v1";
const THREAD_CHANGED_FILES_EXPANSION_VERSION = 1;
const LEGACY_PERSISTED_STATE_KEYS = [
  "shuv2code:renderer-state:v8",
  "shuv2code:renderer-state:v7",
  "shuv2code:renderer-state:v6",
  "shuv2code:renderer-state:v5",
  "shuv2code:renderer-state:v4",
  "shuv2code:renderer-state:v3",
