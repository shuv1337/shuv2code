...
describe("openPullRequestLink", () => {
  it("opens the requested pull request URL", async () => {
    ...
    const targetUrl = "https://github.com/shuv1337/shuv2code/pull/123";
  ...
  it("reports bridge failures with a safe target origin", async () => {
    ...
    const targetUrl = "https://github.com/shuv1337/shuv2code/pull/123?token=secret";
...
describe("parseChangeRequestUrl", () => {
  it("reads a GitHub pull request", () => {
    expect(parseChangeRequestUrl("https://github.com/Shuv1337/Shuv2Code/pull/123")).toEqual({
      host: "github.com",
  ...
  it("reads a GitLab merge request, nested groups and all", () => {
    expect(
      parseChangeRequestUrl("https://gitlab.com/shuv1337/platform/shuv2code/-/merge_requests/42"),
    ).toEqual({
      host: "gitlab.com",
      repository: "shuv1337/platform/shuv2code",
      number: 42,
    });
  });
  ...
  it("reads both Azure DevOps URL forms, keeping `_git` in the repository path", () => {
    expect(
      parseChangeRequestUrl("https://dev.azure.com/acme/platform/_git/shuv2code/pullrequest/17"),
    ).toEqual({
      host: "dev.azure.com",
      repository: "acme/platform/_git/shuv2code",
      number: 17,
    });
    expect(
      parseChangeRequestUrl("https://acme.visualstudio.com/platform/_git/shuv2code/pullrequest/17"),
    ).toEqual({
      host: "acme.visualstudio.com",
      repository: "platform/_git/shuv2code",
      number: 17,
    });
  });
  ...
  it("survives trailing segments, a trailing slash and a query string", () => {
    expect(
      parseChangeRequestUrl("https://github.com/shuv1337/shuv2code/pull/123/files?w=1"),
    ).toEqual({
      host: "github.com",
      repository: "shuv1337/shuv2code",
      number: 123,
  ...
  it("claims nothing it cannot be sure of, so the link goes to the browser", () => {
    for (const link of [
      "https://github.com/shuv1337/shuv2code/issues/123",
      "https://github.com/shuv1337/shuv2code/commit/0a1b2c3",
      "https://github.com/shuv1337/shuv2code",
      "https://github.com/shuv1337/shuv2code/pull/abc",
      "https://gitlab.com/shuv1337/shuv2code/-/snippets/12",
      "https://gitlab.com/shuv1337/shuv2code/-/issues/12",
      ...
      "javascript:alert(1)//github.com/shuv1337/shuv2code/pull/1",
      "not a url",
    ]) {
...
describe("findProjectForChangeRequest", () => {
  ...
  it("matches a nested GitLab group by the whole path below the host", () => {
    ...
    // two-segment owner/name form would look for `shuv1337/shuv2code` and find nothing.
    const projects = [
      project({
        canonicalKey: "gitlab.com/shuv1337/platform/shuv2code",
        provider: "gitlab",
        displayName: "shuv1337/platform/shuv2code",
        owner: "shuv1337",
        name: "shuv2code",
      }),
    ];
