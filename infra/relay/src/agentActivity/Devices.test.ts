import type { RelayDeviceRegistrationRequest } from "@shuv2code/contracts/relay";
...
const registration: RelayDeviceRegistrationRequest = {
  ...
  bundleId: "dev.shuv.shuv2code.nightly" as RelayDeviceRegistrationRequest["bundleId"],
    ...
    return Effect.gen(function* () {
      ...
      expect(insertedValues).toEqual([
        expect.objectContaining({
          userId: "user-2",
          deviceId: "device-1",
          bundleId: "dev.shuv.shuv2code.nightly",
          apsEnvironment: "production",
