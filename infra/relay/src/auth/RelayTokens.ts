...
import { encodeOAuthScope, parseAllowedOAuthScope } from "@shuv2code/shared/oauthScope";
import {
...
const LINK_CHALLENGE_TYP = "shuv2code-link-challenge+jwt";
const ACCESS_TOKEN_TYP = "shuv2code-relay-dpop-access+jwt";
...
>()("shuv2code-relay/auth/RelayTokens") {}
