...
import { signRelayJwt } from "@shuv2code/shared/relayJwt";
  ...
  it.effect("rejects signed DPoP tokens whose scope is outside the relay policy", () =>
    Effect.gen(function* () {
      ...
      const token = yield* signRelayJwt({
        ...
        typ: "shuv2code-relay-dpop-access+jwt",
        payload: {
