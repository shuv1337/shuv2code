...
export const SHOWCASE_PROJECT_ID = "shuv2code";
...
const SHOWCASE_TERMINAL_PROMPT =
  "\u001b[1;32m→\u001b[0m \u001b[1;36mshuv2code\u001b[0m \u001b[1;34mgit:(\u001b[1;31mfeat/remote-command-center\u001b[1;34m)\u001b[0m \u001b[1;33m✗\u001b[0m ";
...
export const SHOWCASE_TERMINAL_BUFFER = [
  ...
  "  \u001b[32m→\u001b[0m  \u001b[2mProject:\u001b[0m  \u001b[1mshuv2code\u001b[0m \u001b[2m— ~/Code/shuv2code\u001b[0m",
  "",
...
const PROJECT_FAVICONS = {
  shuv2code: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128">
...
export const SHOWCASE_PROJECTS = [
  {
    ...
    title: "shuv2code",
    directory: "shuv2code",
    repositoryUrl: "https://github.com/shuv1337/shuv2code.git",
    favicon: PROJECT_FAVICONS.shuv2code,
  },
  {
    id: "react",
    title: "React",
...
async function seedT3CodeWorkspace(workspaceRoot: string): Promise<void> {
  ...
  await NodeFSP.writeFile(
    ...
    `${JSON.stringify({ name: "shuv2code", private: true, scripts: { test: "vp test" } }, null, 2)}\n`,
  );
  await NodeFSP.writeFile(NodePath.join(workspaceRoot, "favicon.svg"), PROJECT_FAVICONS.shuv2code);
  await NodeFSP.writeFile(
...
async function seedCompanionWorkspace(input: {
  ...
  await NodeFSP.writeFile(
    ...
    `# ${input.title}\n\nSeeded by the shuv2code mobile screenshot harness.\n`,
  );
  await initializeRepository({
