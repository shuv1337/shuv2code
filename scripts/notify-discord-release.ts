  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new shuv2code prerelease is available for nightly testers."
          : "A new shuv2code latest release is available.",
...
).pipe(Command.withDescription("Post a shuv2code release announcement to Discord."));
