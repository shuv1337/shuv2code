...
| Action                     | What to do                                                                                                                                                                    |
| -------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Update server**          | Available for the shuv2code Linux background service. Select the button and leave shuv2code open while it prepares, tests, restarts, and reconnects.                          |
...
`npx shuv2code@<version> service update` command on the server machine. That one local update installs the
