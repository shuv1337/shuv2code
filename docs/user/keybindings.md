...
The same configuration lives in `~/.shuv2code/userdata/keybindings.json` on the machine running the
server, if you prefer editing it directly. shuv2code writes the built-in defaults into that file on
