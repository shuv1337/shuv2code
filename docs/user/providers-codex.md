...
This guide is for people who want to use more than one Codex account in shuv2code. For Claude, see
[Claude](./providers-claude.md). For first-time setup, see [Install shuv2code](./install.md).
...
- both accounts can see the same shuv2code/Codex sessions
...
In shuv2code Settings, name it something obvious:
...
In shuv2code Settings, add another Codex provider:
...
shuv2code shows the authenticated email for providers that report one. Emails are blurred by default;
...
If you add a third Codex provider with a completely different `CODEX_HOME path`, shuv2code treats it
