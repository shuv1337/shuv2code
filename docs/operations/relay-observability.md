...
- `shuv2code-relay-traces-prod`, an OpenTelemetry trace dataset for Worker requests
- `shuv2code-relay-otel-ingest-prod`, a dataset-scoped ingest token bound to the Worker
