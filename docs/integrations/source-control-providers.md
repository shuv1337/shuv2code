...
shuv2code connects directly to your Git hosting provider so you can create pull requests, review code, and manage repositories without leaving your editor. Work stays in flow—no more jumping between browser tabs and terminal windows.
...
2. Add these environment variables to the environment running shuv2code:
   ```bash
   export SHUV2CODE_BITBUCKET_EMAIL="you@example.com"
   export SHUV2CODE_BITBUCKET_API_TOKEN="your-token"
   ```
3. Restart shuv2code and verify the connection in **Source Control settings**
